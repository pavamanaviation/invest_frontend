    ...
    if (window.google) {
      window.google.accounts.id.prompt((notification) => {
        if (notification.isNotDisplayed() || notification.isSkippedMoment()) {
          setPopup({ isOpen: true, message: "Google Sign-in was not completed. Please try again.", type: "info" });
        }
      });
    } else {
      setPopup({ isOpen: true, message: "Google Sign-in not loaded yet. Please refresh.", type: "error" });
    }
  };
